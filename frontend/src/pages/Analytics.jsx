...
const Analytics = () => {
  ...
  // Check if data is loaded and in the correct format
  if (!data || !Array.isArray(data.temperatureData) || data.temperatureData.length === 0) {
    return (
  ...
  // Ensure temperatureData has the required fields
  const chartData = data.temperatureData.map(item => ({
    ...item,
